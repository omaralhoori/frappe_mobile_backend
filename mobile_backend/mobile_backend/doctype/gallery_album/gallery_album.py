...
def get_albums():
	...
	return frappe.db.sql("""
		SELECT a.name, a.restricted, a.branch, a.class_code, a.section ,a.title, a.description, a.creation, a.likes, a.views, a.approved_comments, ftable.file_url ,IF(tv.user IS NULL,0,1) AS is_viewed,  IF(tl.user IS NULL,0,1) AS is_liked from `tabGallery Album` as a
